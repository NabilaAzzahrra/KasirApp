                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card card-outline card-info">
                                ...
                                <form action="<?= base_url('Admin/cetak_laporan_supplier'); ?>" target="_blank">
                                    <div class="card-body">
                                        <div class="form-group">
                                            <label>Supplier</label>
                                            <select name="supplier" class="form-control select2 select2-info" data-dropdown-css-class="select2-info" style="width: 100%;" data-placeholder="Pilih Supplier" required>

                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card card-outline card-info">
                                ...
                                <form action="<?= base_url('Admin/cetak_laporan_owner'); ?>" target="_blank">
                                    <div class="card-body">
                                        <div class="form-group">
                                            <label>Owner</label>
                                            <select name="owner" class="form-control select2 select2-info" data-dropdown-css-class="select2-info" style="width: 100%;" data-placeholder="Pilih Owner" required>

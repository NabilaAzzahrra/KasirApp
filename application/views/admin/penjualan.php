											...
											?>
												<tr>
													...
													<td class="text-center">
														<div class="btn-group">
															<a class="btn bg-gradient-warning" href="<?= base_url('Admin/CetakFakturPenjualan/' . $d->id); ?>" target="_blank"><i class="fal fa-print"></i></a>
					...
					<div class="modal-body">
						...
						<span id="modal-body-update-or-create">
							<div class="form-group">
								...
								<select name="id_customer" class="form-control select2 select2-info" data-dropdown-css-class="select2-info" style="width: 100%;" data-placeholder="Pilih Customer" onchange="return cekCustomer()">
...
<script>
	...
	function tambah() {
		...
		$("[name='form']").attr('action', '<?= base_url('Admin/SaveTransaksiPenjualan'); ?>');
	}

	function hapus(id, nama_produk) {
		$('#Modal').modal('show');
		$('.modal-dialog').removeClass('modal-lg');
		$('#modal-header').html('Hapus Penjualan');
		...
		$("[name='form']").removeAttr('action');
		$("[name='form']").attr('action', '<?= base_url('Admin/penjualan_delete'); ?>');
	}
</script>

                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <div class="btn-group">
                                                            <button class="btn bg-gradient-warning" onclick="return ubah(`<?= $d->id ?>`, `<?= $d->nama_supplier ?>`, `<?= $d->no_hp ?>`, `<?= $d->alamat ?>`)"><i class="fal fa-edit"></i></button>
                    ...
                    <div class="modal-body">
                        ...
                        <span id="modal-body-update-or-create">
                            <div class="form-group">
                                ...
                                <input type="text" name="nama_supplier" class="form-control" placeholder="Nama Supplier" maxlength="50">
                            </div>
                            <div class="form-group">
                                <label>No. HP</label>
...
<script>
    ...
    function tambah() {
        $('#Modal').modal('show');
        $('#modal-header').html('Tambah Supplier');
        ...
        $('[name="alamat"]').val("");
        $('[name="no_hp"]').val("");
        document.form.action = '<?= base_url('Admin/supplier_add'); ?>';
    }

    function ubah(id, nama_supplier, no_hp, alamat) {
        $('#Modal').modal('show');
        $('#modal-header').html('Ubah Supplier');
        $('#batal').removeClass('bg-gradient-success').addClass('bg-gradient-danger');
        $('#modal-button').removeClass('bg-gradient-danger').addClass('bg-gradient-success');
        $('#modal-body-update-or-create').removeClass('d-none');
        $('#modal-body-delete').addClass('d-none');
        ...
        document.form.action = '<?= base_url('Admin/supplier_update'); ?>';
    }

    function hapus(id, nama_supplier) {
        $('#Modal').modal('show');
        $('#modal-header').html('Hapus Supplier');
        ...
        document.form.action = '<?= base_url('Admin/supplier_delete'); ?>';
    }
</script>

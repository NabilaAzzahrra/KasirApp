        ...
        <div class="content-wrapper">
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Laporan Supplier</h1>
                        </div>
                        <div class="col-sm-6">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card card-outline card-primary">
                                ...
                                <form action="<?= base_url('Kasir/cetak_laporan_supplier'); ?>" target="_blank">
                                    <div class="card-body">
                                        <div class="form-group">
                                            <label>Supplier</label>
                                            <select name="supplier" class="form-control select2 select2-primary" data-dropdown-css-class="select2-primary" style="width: 100%;" data-placeholder="Pilih Supplier" required>
                                                <?php foreach ($supplier as $o) { ?>
                                                    <option value="<?= $o->id ?>"><?= $o->nama_supplier ?></option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                        <div class="form-group">

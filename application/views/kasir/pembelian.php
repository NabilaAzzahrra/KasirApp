											...
											?>
												<tr>
													...
													<td class="text-center">
														<div class="btn-group">
															<a class="btn bg-gradient-primary" href="<?= base_url('Kasir/CetakFakturPembelian/' . $d->id); ?>" target="_blank"><i class="fal fa-print"></i></a>
														</div>
													</td>
												</tr>
											<?php } ?>
					...
					<div class="modal-body">
						...
						<span id="modal-body-update-or-create">
							<div class="form-group">
								...
								<select name="id_supplier" class="form-control select2 select2-primary" data-dropdown-css-class="select2-primary" style="width: 100%;" data-placeholder="Pilih Supplier">
...
<script>
	...
	function tambah() {
		...
		$("[name='form']").attr('action', '<?= base_url('Kasir/SaveTransaksiPembelian'); ?>');
	}
</script>
